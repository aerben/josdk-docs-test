...
[dependent resources](dependent-resources.md) feature.
...
[dependent resources](dependent-resources.md) (DR) depend on one
...
using [standalone dependent resources](dependent-resources.md#standalone-dependent-resources)
...
[Cleanup](../reconciler.md#implementing-a-reconciler-and-cleaner-interfaces) is
